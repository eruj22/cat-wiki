  ...
  return (
    <>
      <article className="article">
        <h1 className="article__title">Top 5 Reasons You Should Have a Cat</h1>
        <img
          className="article__image"
          src={image2}
          alt="cat lying in the arms, comfortably"
        />
        <p className="italic">
        ...
        <h2 className="article__subtitle">1. Cats can bathe themselves</h2>
        <p>
        ...
        <h2 className="article__subtitle">
          2. Cats will keep your house and yard rodent-free
        </h2>
        <p>
        ...
        <h2 className="article__subtitle">
          3. Cats are low-maintenance and independent
        </h2>
        <p>
        ...
        <h2 className="article__subtitle">
          4. Cats are an eco-friendly pet choice
        </h2>
        <p>
        ...
        <h2 className="article__subtitle">5. Cats can help reduce stress</h2>
        <p>
